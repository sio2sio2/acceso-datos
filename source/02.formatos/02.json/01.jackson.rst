...
Para ilustrarlo, podemos definir las tres clases que modela el :ref:`archivo
...
.. code-block:: java
   ...
   // MapperBuilder<?, ?> o JsonMapper.Builder
   ...
   // ObjectMapper o JsonMapper
   ObjectMapper mapper = builder.build();

.. note::
   :collapsible: closed

   |MapperBuilder| y |ObjectMapper| son clases padre que se comparten con
...
.. code-block:: java
   ...
   public class Traductor {
       ...
       public static class DateSerializer extends ValueSerializer<LocalDate> {
       ...
       public static class DateDeserializer extends ValueDeserializer<LocalDate> {
