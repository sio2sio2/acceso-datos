...
.. code-block:: java
   ...
   // Si queremos cerrar y eliminar la fábrica
   JpaBackend.removeEntityManagerFactory("MiUnidadP");

.. tip:: En caso de que sólo se haya creado una, ni siquiera es necesario usar
   la clave:

   .. code-block:: java

      Centro otro = JpaBackend.transactionR(em -> em.get(Centro.class, 11004866L));
