...
pero este sólo no no dará quebraderos de cabeza en aplicaciones muy simples que
no se prevee que crezcan en el futuro.

.. todo:: SEGUIR corrigiendo todo este apartado.
...
<conn-pool-extra>` ) (o una clase más específica de nuestra aplicación que
...
|DataSource| (en realidad, el objeto :ref:`ConnectionPool <conn-pool-extra>`) que nos
