...
Podemos proponer ésta como casi calco de :ref:`ConnectionPool
<clase-connectionpool>`, propuesta en la unidad anterior para |JDBC|:

.. literalinclude:: files/JpaBackend.java
   :class: toggle
   :caption: JpaBackend.java (:download:`descarga <files/JpaBackend.java>`)
   :name: clase-jpabackend
   :language: java
   :start-at: /**
...
.. tip:: Las transacciones también se pueden abrir con un método estático
