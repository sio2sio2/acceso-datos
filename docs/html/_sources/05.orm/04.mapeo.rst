...
**Relación 1:N**: ``@OneToMany``/``@ManyToOne``
   ...
   En Hibernate_ hay dos modos de resolver esta relación (y las otras dos que se
   ...
   **Bidireccional**
      ...
      acceder a su valor. El *setter*, en cambio, no es indispensable.

      Esta alternativa nos permite conocer todos los estudiantes matriculados en
      un centro de modo sencillo, pero introduce complejidad en la
