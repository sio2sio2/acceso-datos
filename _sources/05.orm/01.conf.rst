...
* El soporte para |JPA| que proporciona Hibernate_ mediante hibernate-core_.
  Podemos incluir explócitamente , aunque no es necesario, la especificación
...
.. caution:: No basta con crear el archivo de recursos, sino que este debe pasar
   a la aplicación compilada para que la implementación de |JPA| pueda
   encontrarlo. :ref:`Ya tratamos ello en la primera unidad <file-arc-pro>` y exigía, si usamos
   :ref:`Maven`, declararlo en :file:`pom.xml` :ref:`como se explica en su apéndice <add-resources>`:
