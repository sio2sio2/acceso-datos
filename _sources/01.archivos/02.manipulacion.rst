...
.. important:: Se está suponiendo que el código está dentro de un método de
...
.. note::
   ...
   En las siguientes unidades, para el tratamiento de archivos en
...
.. hint:: El método ``lines()`` devuelve un flujo por líneas (``Stream<String>``)
