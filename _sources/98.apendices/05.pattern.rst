...
.. tip:: Una variante de este patrón es que queramos crear no una instancia,
   ...
   esos valores. A este *singleton ampliado* se le suele denominar `Multiton
   <https://en.wikipedia.org/wiki/Multiton_pattern>`_ y hay algunos ejemplos en
   el texto de estos apuntes (véase, por ejemplo, :ref:`JdbcConnection
   <conn-pool-extra>`).
...
Por tanto, queramos traducir a lo que queramos traducir, la clase responsable
...
.. note:: Esta clase necesita la librería classgraph_:
...
Observer
========
El patrón *Observer* (u *Observador*) es una estrategia para ampliar las
funcionalidades de un objeto basada en la composición y no en la herencia.

Se basa en la existencia de un objeto *observado* (denominado *sujeto*) en el
que se registran una serie de objetos *observadores*. En tal objeto se producen
una serie de cambios de estado (eventos) y, cuando tales cambios se llevan a
cabo, los notifica a los observadores, para que éstos realicen las acciones para
las que han sido programados. Hay, por tanto, una delegación de las reacciones
que deben originarse ante el cambio de estado.

Para ilustrar su uso

.. |YAML| replace:: :abbr:`YAML (YAML Ain't Markup Language)`
.. _classgraph: https://mvnrepository.com/artifact/io.github.classgraph/classgraph
