...
- Los gestores difieren entre sí, puesto que a lo único que les obliga la
  ...
  .. caution:: Cuando se pretende usar el gestor integrado :ref:`no debe
...
.. code-block:: java
   ...
   // Le decimos explícitamente a ConnectionPool cómo
   ConnectionPool.create("BD", "jdbc:sqlite:file::memory:?cache=shared", null, null, factory);
