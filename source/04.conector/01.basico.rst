...
.. caution:: La conexión a una base de datos es una **operación costosa**, por lo
   ...
   se penalizará. Lo habitual es una aplicación que sea algo más que una prueba
   de concepto, es utilizar un :ref:`pool de conexiones <conn-pool>`, que es capaz
   de reaprovechar conexiones, puesto que en realidad no las acaba de cerrar.
