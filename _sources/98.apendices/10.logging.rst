...
.. warning::
   ...
   La especificación se limita a definir cómo se envían mensajes al
   ...
   .. table::
      ...
      |  Aspecto           | Definición                              |
      +====================+=========================================+
      | Envío de mensajes  | Común (definida por la implementación)  |
      +--------------------+-----------------------------------------+
      | Nivel registrable  |                                         |
      +--------------------+                                         |
...
=======================
.. note:: |SLF4J| se limita a especificar el envío de mensajes, por lo que
   toda la configuración adicional que queramos hacer a ese envío depende de
   la librería de implementación. En nuestro caso, este apartado se centra en
...
.. tip::
   ...
   El atributo ``debug`` provoca que se vuelquen en la consola mensajes
...
.. tip::
   ...
   En un sistema UNIX también existe la posibilidad de integrar los
