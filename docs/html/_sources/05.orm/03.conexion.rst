...
la base de datos. Así pues, está fábrica es el punto de acceso para interacturar
...
* Implementa el `patrón Singleton`_, de modo que, mientras no se cierre el
  objeto, siempre se devuelve el mismo objeto, lo que equivale a que siempre se
  maneja la misma fábrica de sesiones.
