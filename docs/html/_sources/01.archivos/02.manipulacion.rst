...
.. note:: Al establecer el lector a partir del flujo  de entrada debemos indicar
   qué codificación se usa. Si no se especifica, se sobreentiende que es UTF-8,
   de modo que a partir de ahora, no volveremos a indicarlo:
