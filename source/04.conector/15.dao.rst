...
y complementar este patrón nos basta con usar |ConnectionPool|
...
.. note:: En realidad, como consecuencia de nuestra simplificación, no es
   necesario pasar ningún argumento al constructor, ya que la obtención del
   objeto ``Conexion`` no lo necesita. Pero para no perder generalidad en los
   |DAO|, optamos por incluir la clave.
...
.. note:: La librería sqlutils_ implementa, además, una suerte de |ORM| muy
   ...
   hacerse una idea de cómo se ha hecho.
...
.. |ConnectionPool| replace:: :ref:`ConnectionPool <conn-pool-extra>`
